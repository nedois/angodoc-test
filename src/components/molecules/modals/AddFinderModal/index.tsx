...
import AddAgencyForm from './AddFinderForm';

export interface AddFinderModalProps {
  open: boolean;
  onClose: () => void;
  onSuccess: (agency: Agency) => void;
}

const AddFinderModal: React.FC<AddFinderModalProps> = ({ open, onClose, onSuccess }) => {
