...
const AgenciesHelpPage: MyNextPage = () => {
  ...
  return (
    <>
      <NextSeo title="Centro de ajuda | Agências" description="Informações úteis relevantes as agências" />
      <PageBanner
        title="Centro de ajuda | Agências"
        description="Informações úteis relevantes as agências"
...
AgenciesHelpPage.layout = AppLayout;

export default AgenciesHelpPage;
